...
<div class="allcontain"  style="margin-top: 100px;">
        <div class="image">
        ...
        <div class="loginform">
            <h1>login</h1>
            <form action="verfication_login.php" method="post">
            ...
            <p>alredt have an account?<span><a href="singup.php">singup</a></span></p>
        </div>
    </div>
