...
?>
    ...
    <?php
        include("../config/conect.php");
        $query="SELECT product.id_product,catégorie.id_catégorie,nom_product,image_product,price,libelle from product join catégorie on product.id_catégorie=catégorie.id_catégorie";
    ...
    ?>
        <div class="product">
            <a href="single_product.php?id_product=<?php echo $product['id_product']  ?>&id_catégorie=<?php echo $product['id_catégorie']?>">
                <img src= "<?php  echo $product['image_product'] ?>" alt="">
            </a>
            <p><?php echo $product['libelle']    ?></p>
            <h4  class="name-produit-shop-page"><?php echo $product['nom_product'] ?></h4>
            <div class="starts">
